...
function BookRentalSection() {
  const steps = [
    ...
    },
    {
      ...
      content: (
        <p className="font-manrope text-sm text-secondary/80">
          Pay 50% down payment (or full amount) and send proof of payment. A booking is only confirmed once acknowledged by our team.
        </p>
      ),
    },
    {
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="font-manrope text-sm text-secondary/80">
                  A 50% down payment (or agreed amount) secures your order. Bookings are confirmed once acknowledged via Facebook, Email, or Instagram.
                </p>
              </div>
            </div>
