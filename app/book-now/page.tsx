        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <ul className="space-y-2 font-manrope text-sm text-secondary/80">
              ...
              <li className="flex items-start gap-2">
                <span className="text-secondary font-bold">•</span>
                <span><strong>Companions:</strong> Clients may only bring <strong>2–3 companions</strong> inside the fitting area. This is to maintain a comfortable and organized space for everyone.</span>
              </li>
            </ul>
          </div>
