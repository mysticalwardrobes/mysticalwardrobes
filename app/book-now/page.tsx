          ...
          <div className="bg-gradient-to-br from-yellow-50 to-amber-50 border-2 border-yellow-300 rounded-lg p-4">
            ...
            <ul className="space-y-2 font-manrope text-sm text-secondary/80">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Fitting schedules are confirmed only after payment of the fitting fee. Rescheduling is not allowed by default; if an exception is permitted and approved, a ₱400 rescheduling fee applies per approved move.</span>
              </li>
            </ul>
          </div>
