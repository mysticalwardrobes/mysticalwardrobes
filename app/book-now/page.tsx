          ...
          <div>
            ...
            <ul className="space-y-2 font-manrope text-sm text-secondary/80">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Time Allotted:</strong> Clients have 30-40 minutes allotted for their fitting and decision making. You can try on 3-4 gowns during this session.</span>
              </li>
            </ul>
          </div>
