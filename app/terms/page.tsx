        ...
        <div className="space-y-8 font-manrope leading-relaxed text-secondary/80">
          ...
          <FadeInOnScroll delay={0.3}>
            <section className="bg-white/95 rounded-lg border border-foreground/10 p-6 shadow-md md:p-8">
              ...
              <p className="mb-4">
                Cancellation and rescheduling policies apply as outlined in our specific service terms. For gown rentals and fittings, once paid and booked, payments are strictly non-refundable. Mystical Wardrobes is not liable for resulting losses if an event is canceled or rescheduled.
              </p>
            </section>
          </FadeInOnScroll>
